...
**控制器**: `com.soeasyeasy.user.controller.UserController#getById()`  
**方法描述**: 根据id查询
...
### 返回类型
`com.soeasyeasy.user.entity.dto.UserDTO`
...
### 返回类型
`List<[com.soeasyeasy.user.entity.dto.UserDTO](#com.soeasyeasy.user.entity.dto.userdto)>`
**包含类型**:
- [com.soeasyeasy.user.entity.dto.UserDTO](#com.soeasyeasy.user.entity.dto.userdto)
...
### 返回类型
`com.soeasyeasy.common.entity.PageResult<com.soeasyeasy.user.entity.dto.UserDTO>`
